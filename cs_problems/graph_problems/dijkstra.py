...
from cs_problems.search_problems.generic_search import PriorityQueue
...
class DijkstraNode:
    ...
    def __lt__(self, other: DijkstraNode) -> Node:
...
# Takes a dictionary of edges to reach each node and
# returns a list of edges that goes from 'start' to 'end'
