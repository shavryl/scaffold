...
class SendMoreMoney2(Chromosome):
    ...
    def fitness(self) -> float:
        ...
        money: int = m * 100000 + o * 1000 + n * 100 + e * 10 + y
...
if __name__ == "__main__":
    ...
    ga: GeneticAlgorithm[SendMoreMoney2] = GeneticAlgorithm(initial_population=initial_population, threshold=1.0, max_generations = 1000,
     mutation_chance = 0.2, crossover_chance = 0.7, selection_type=GeneticAlgorithm.SelectionType.ROULETTE)
